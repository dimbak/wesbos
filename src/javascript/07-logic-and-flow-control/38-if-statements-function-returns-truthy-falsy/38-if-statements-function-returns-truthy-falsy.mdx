...
What this code will do is it will check the parenthesis. Name must equal "scott" OR name must equal "wes" and last equal "bos" for the statement to return true.
